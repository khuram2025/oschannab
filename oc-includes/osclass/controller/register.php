    ...
    public function doModel() {
        switch($this->action) {
            ...
            case('register_post'):  // register user action (form submitted)
                ...
                $allowed_domains = array('gmail.com', 'hotmail.com', 'yahoo.com');
                $email_domain = substr(strrchr(Params::getParam('s_email'), "@"), 1);
                if (!in_array($email_domain, $allowed_domains)) {
                    osc_add_flash_error_message(_m('Registration is only allowed from certain domains. Please use an email from an allowed domain.'));
                ...
                // Continue with user registration (assuming you have this code)
            ...
            case('validate'):     // validate account
                ...
                if($success) {
                    ...
                    osc_add_flash_error_message(_m('Account validation failed'));
                }
